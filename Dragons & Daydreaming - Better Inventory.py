...
def help():
    ...
    typewrite("1. Travel [Allows you to travel between locations.]")
    typewrite("2. Search [You search the area you are located in. You can find items & monsters. Different locations have different items & monsters.]")
    typewrite("3. Get Map [You get a map. Can only be used in towns.]")
    typewrite("4. Map [Opens the map]")
    typewrite("5. Talk / Greet NPC [You talk to an Npc for information. Can only be used in a town.]")
    typewrite("6. Boss Fight [Starts the boss fight if at dark peak mountain.]")
    typewrite("7. Rest / Sleep [You go to sleep. Restores your health to 100. Fun things happen.]")
    typewrite("8. Quit [Quits the game. But be careful! You can't save.]")
    typewrite("9. Check Stats / Status Check [Prints the # of days played, # of enemies killed, & player & world names]")
    typewrite("10. Check Inventory [Shows you the stuff in your inventory.]")
    typewrite("11. Clear Console [Clears the screen/console of all text]")
    typewrite("12. Mini Game [Starts a mini game. There are 5 different mini games, 1 for each town.]")
def list_check():
...
def main_game():
    world()
    start()
    global choice, has_map, health, enemies_killed
    while health > 0:
